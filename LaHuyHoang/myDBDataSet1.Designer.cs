...
namespace LaHuyHoang {
    ...
    public partial class myDBDataSet1 : global::System.Data.DataSet {
        ...
        public partial class stdDataTable : global::System.Data.TypedTableBase<stdRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public stdRow AddstdRow(int id, string fname, string lname, System.DateTime bdate, string gender, string address, string phone, byte[] picture) {
...
namespace LaHuyHoang.myDBDataSet1TableAdapters {
    ...
    public partial class stdTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[std] ([id], [fname], [lname], [bdate], [gender], [address], [phone], [picture]) VALUES (@id, @fname, @lname, @bdate, @gender, @address, @phone, @picture);
SELECT id, fname, lname, bdate, gender, address, phone, picture FROM std WHERE (id = @id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[std] SET [id] = @id, [fname] = @fname, [lname] = @lname, [bdate] = @bdate, [gender] = @gender, [address] = @address, [phone] = @phone, [picture] = @picture WHERE (([id] = @Original_id) AND ((@IsNull_fname = 1 AND [fname] IS NULL) OR ([fname] = @Original_fname)) AND ((@IsNull_lname = 1 AND [lname] IS NULL) OR ([lname] = @Original_lname)) AND ((@IsNull_bdate = 1 AND [bdate] IS NULL) OR ([bdate] = @Original_bdate)) AND ((@IsNull_gender = 1 AND [gender] IS NULL) OR ([gender] = @Original_gender)) AND ((@IsNull_address = 1 AND [address] IS NULL) OR ([address] = @Original_address)) AND ((@IsNull_phone = 1 AND [phone] IS NULL) OR ([phone] = @Original_phone)));
SELECT id, fname, lname, bdate, gender, address, phone, picture FROM std WHERE (id = @id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::LaHuyHoang.Properties.Settings.Default.myDBConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, fname, lname, bdate, gender, address, phone, picture FROM dbo.std";
        ...
        public virtual int Delete(int Original_id, string Original_fname, string Original_lname, global::System.Nullable<global::System.DateTime> Original_bdate, string Original_gender, string Original_address, string Original_phone) {
        ...
        public virtual int Insert(int id, string fname, string lname, global::System.Nullable<global::System.DateTime> bdate, string gender, string address, string phone, byte[] picture) {
        ...
        public virtual int Update(int id, string fname, string lname, global::System.Nullable<global::System.DateTime> bdate, string gender, string address, string phone, byte[] picture, int Original_id, string Original_fname, string Original_lname, global::System.Nullable<global::System.DateTime> Original_bdate, string Original_gender, string Original_address, string Original_phone) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string fname, string lname, global::System.Nullable<global::System.DateTime> bdate, string gender, string address, string phone, byte[] picture, int Original_id, string Original_fname, string Original_lname, global::System.Nullable<global::System.DateTime> Original_bdate, string Original_gender, string Original_address, string Original_phone) {
            return this.Update(Original_id, fname, lname, bdate, gender, address, phone, picture, Original_id, Original_fname, Original_lname, Original_bdate, Original_gender, Original_address, Original_phone);
        }
    }
