...
namespace LaHuyHoang {
    ...
    public partial class myDBDataSet : global::System.Data.DataSet {
        ...
        public partial class stdDataTable : global::System.Data.TypedTableBase<stdRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public stdRow AddstdRow(int id, string fname, string lname, System.DateTime bdate, string gender, string address, byte[] picture) {
...
namespace LaHuyHoang.myDBDataSetTableAdapters {
    ...
    public partial class stdTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[std] ([id], [fname], [lname], [bdate], [gender], [address], [p" +
                "icture]) VALUES (@id, @fname, @lname, @bdate, @gender, @address, @picture);\r\nSEL" +
                "ECT id, fname, lname, bdate, gender, address, picture FROM std WHERE (id = @id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[std] SET [id] = @id, [fname] = @fname, [lname] = @lname, [bdate] = @bdate, [gender] = @gender, [address] = @address, [picture] = @picture WHERE (([id] = @Original_id) AND ((@IsNull_fname = 1 AND [fname] IS NULL) OR ([fname] = @Original_fname)) AND ((@IsNull_lname = 1 AND [lname] IS NULL) OR ([lname] = @Original_lname)) AND ((@IsNull_bdate = 1 AND [bdate] IS NULL) OR ([bdate] = @Original_bdate)) AND ((@IsNull_gender = 1 AND [gender] IS NULL) OR ([gender] = @Original_gender)) AND ((@IsNull_address = 1 AND [address] IS NULL) OR ([address] = @Original_address)));
SELECT id, fname, lname, bdate, gender, address, picture FROM std WHERE (id = @id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, fname, lname, bdate, gender, address, picture FROM dbo.std";
        ...
        public virtual int Delete(int Original_id, string Original_fname, string Original_lname, global::System.Nullable<global::System.DateTime> Original_bdate, string Original_gender, string Original_address) {
        ...
        public virtual int Insert(int id, string fname, string lname, global::System.Nullable<global::System.DateTime> bdate, string gender, string address, byte[] picture) {
        ...
        public virtual int Update(int id, string fname, string lname, global::System.Nullable<global::System.DateTime> bdate, string gender, string address, byte[] picture, int Original_id, string Original_fname, string Original_lname, global::System.Nullable<global::System.DateTime> Original_bdate, string Original_gender, string Original_address) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string fname, string lname, global::System.Nullable<global::System.DateTime> bdate, string gender, string address, byte[] picture, int Original_id, string Original_fname, string Original_lname, global::System.Nullable<global::System.DateTime> Original_bdate, string Original_gender, string Original_address) {
            return this.Update(Original_id, fname, lname, bdate, gender, address, picture, Original_id, Original_fname, Original_lname, Original_bdate, Original_gender, Original_address);
        }
    }
